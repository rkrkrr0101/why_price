...
class CreateReportServiceTest
    @Autowired
    constructor(
        reportCachesJpaRepository: ReportCachesJpaRepository,
        ...
        fun expiredUpdateCacheReport() {
            runTest {
                ...
                Assertions
                    .assertThat(reportCache.getCreateTime())
                    .isEqualTo(CustomDateTimeMock(TestConstant.TEST_CURRENT_TIME).getNow())
            }
        }
    }
